function [x,fval] = loadProfile(dam_9_5,ev_charge, max_charging_cap,ev_charge_initial)
...
b_charge_max(1:len,1) = ev_charge; % to make sure the battery doesnt get charged above max capacity
