...
ev_charge_initial = 1846; %DIT MOET NOG AANGEPAST WORDEN MAAR IK WEET NIET MEER HOE WE DAT BEREKEND HEBBEN
...
opex_diesel = Citroen_fuel_cost+Citroen_maintanance;
